...
t.sleep(3)
#this is a for loop that prints out all of the items in the dictionary in a good way that is inside of a function
def menu():
...
while True:
    ...
    main_choice = input("Now what main course would you like?\n").lower()
    #if statement that checks whether the user actually put something that is in the menu
    if main_choice in main:
        choice = main[main_choice]
...
while True:
    side_choice = input("Now what side would you like?\n").lower()
    if side_choice in sides:
        choice2 = sides[side_choice]
        break
    else:
        print("Your choice is not on the menu")
while True:
    side_choice2 = input("Now what is your second side?\n").lower()
    if side_choice2 in sides:
        choice3 = sides[side_choice2]
        break
    else:
        print("Your choice is not on the menu")
while True:
    des_choice = input("Now what dessert would you like?\n").lower()
    if des_choice in des:
        choice4 = des[des_choice]
        break
    else:
        print("Your choice is not on the menu")
#this adds all of the choice's pices together for the total
total = main[main_choice] + sides[side_choice] + sides[side_choice2] + des[des_choice]
#this set of print statements shows what they ordered and the final price
print(f"Your main course is {main_choice} and it is ${choice}")
print(f"Your side dish is {side_choice} and it is ${choice2}")
print(f"Your second side is {side_choice2} and it is ${choice3}")
print(f"Your dessert is {des_choice} and it is ${choice4}")
